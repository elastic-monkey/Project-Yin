...
public class EnemyBehaviorEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_script.AttackDefense = ClampStep((int)GUILayout.HorizontalSlider(
			_script.AttackDefense, EnemyBehavior.MinAttackDefense, EnemyBehavior.MaxAttackDefense, GUILayout.Width(fieldWidth)),
			EnemyBehavior.MinAttackDefense, EnemyBehavior.MaxAttackDefense, EnemyBehavior.AttackDefenseSliderStep);
		...
		_script.Courage = ClampStep((int)GUILayout.HorizontalSlider(
			_script.Courage, EnemyBehavior.MinCourage, EnemyBehavior.MaxAttackDefense, GUILayout.Width(fieldWidth)),
			EnemyBehavior.MinCourage, EnemyBehavior.MaxCourage, EnemyBehavior.CourageSliderStep);
